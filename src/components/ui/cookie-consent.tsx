        ...
        {showDetails && (
          <div className='border-border bg-muted/50 mt-4 space-y-4 rounded-lg border p-4'>
            <div className='flex items-center justify-between'>
              ...
              <input type='checkbox' checked={preferences.necessary} disabled className='border-border h-4 w-4 rounded' />
            </div>
            ...
            <div className='flex items-center justify-between'>
              ...
              <input type='checkbox' checked={preferences.analytics} onChange={e => setPreferences({ ...preferences, analytics: e.target.checked })} className='border-border h-4 w-4 rounded' />
            </div>
            ...
            <div className='flex items-center justify-between'>
              ...
              <input type='checkbox' checked={preferences.marketing} onChange={e => setPreferences({ ...preferences, marketing: e.target.checked })} className='border-border h-4 w-4 rounded' />
            </div>

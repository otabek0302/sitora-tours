  ...
  return (
    <div key={city.id} className='embla__slide w-full flex-shrink-0 lg:w-[calc(25%-18px)]'>
      <Link href={`/cities/${city.slug}`}>
        <div className='bg-card border-border group relative h-[300px] cursor-pointer overflow-hidden rounded-[26px] border shadow-none transition-all duration-300 hover:shadow-sm lg:h-[480px]'>
          {/* City Image */}
          {city.image?.url ? (

...
const HotelGallery = ({ images, name }: HotelGalleryProps) => {
  ...
  return (
    <div className='space-y-4'>
      {/* Main Image */}
      <div className='border-border relative h-[400px] w-full overflow-hidden rounded-[32px] border shadow-none lg:h-[620px]'>

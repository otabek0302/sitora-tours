          ...
          <div className='space-y-2'>
            <div className='flex items-start gap-3'>
              ...
              <div className='flex-1'>
                <h3 className='text-sitora-text-subtitle mb-1 text-sm font-semibold'>Address</h3>
        ...
        {hotel.phone && (
          <div className='border-border border-t pt-6'>
            <div className='flex items-start gap-3'>
              ...
              <div className='flex-1'>
                <h3 className='text-sitora-text-subtitle mb-1 text-sm font-semibold'>Phone</h3>

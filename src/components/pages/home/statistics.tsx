      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-6'>
          ...
          <div className='border-border md:border-r md:pr-4 text-center md:text-left'>
            ...
            <p className='text-sitora-body text-xs leading-relaxed font-normal sm:text-sm lg:text-base'>{t('experience')}</p>
          </div>
          <div className='border-border text-center md:text-left'>
            <div className='mb-2 md:mb-4'>
              <span className='text-sitora-text-subtitle text-3xl font-bold sm:text-4xl lg:text-6xl'>+100</span>
              <span className='text-sitora-text-subtitle ml-1 text-xl font-bold sm:text-2xl lg:ml-2 lg:text-3xl'>{t('countries')}</span>
            </div>
            <p className='text-sitora-body text-xs leading-relaxed font-normal sm:text-sm lg:text-base'>{t('countries_description')}</p>
          </div>
        </div>
      </div>
    </section>

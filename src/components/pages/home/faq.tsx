...
const Faq = () => {
  ...
  const { getFAQSection } = usePagesContext()
  const { faqs } = getFAQSection() || {}
  ...
  return (
    <section className='py-6 lg:py-8'>
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='bg-card border-border rounded-[32px] border p-6 shadow-none transition-all duration-300 hover:shadow-sm sm:p-8 lg:p-10'>
          {/* Section Header */}

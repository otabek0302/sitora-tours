      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='relative'>
          <div className='embla' ref={emblaRef}>
            <div className='embla__container flex gap-4 py-4 pl-1'>{Array.isArray(cars) && cars.filter(car => typeof car !== 'number' && car !== null).map(car => <RecommendedCarsCard key={car.id} car={car} />)}</div>
          </div>
        </div>

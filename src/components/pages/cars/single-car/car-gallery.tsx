...
const CarGallery = ({ images, name }: CarGalleryProps) => {
  ...
  if (!images || images.length === 0) {
    return (
      <div className='bg-sitora-primary-light border-border flex h-[400px] w-full items-center justify-center rounded-2xl border lg:h-[500px]'>
  ...
  return (
    <div className='space-y-4'>
      {/* Main Image */}
      <div className='border-border relative h-[400px] w-full overflow-hidden rounded-2xl border lg:h-[500px]'>

...
const AboutCta = () => {
  ...
  return (
    <div className='bg-sitora-primary-light dark:bg-card relative z-10 flex flex-col items-center justify-center rounded-[32px] p-12 shadow-none'>
      ...
      <div className='flex flex-col gap-4 sm:flex-row sm:justify-center'>
        <div className='flex gap-4'>
          <Button variant='default' size='sm' className='group bg-sitora-primary-light hover:bg-sitora-primary shadow-none'>
            <Link href='/tours' className='text-md flex items-center justify-center gap-2 leading-tight font-normal'>
          ...
          <Button variant='default' size='sm' className='group bg-sitora-primary-light hover:bg-sitora-primary shadow-none'>
            <Link href='/contact-us' className='text-md flex items-center justify-center gap-2 leading-tight font-normal'>

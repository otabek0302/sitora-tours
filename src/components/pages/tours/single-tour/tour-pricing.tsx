  ...
  if (!tour.booking_pricing || tour.booking_pricing.length === 0) {
    return (
      <div className='mb-8'>
        ...
        <div className='bg-card border-sitora-border rounded-3xl border p-6 text-center'>
  ...
  return (
    <div className='mb-8'>
      ...
      <div className='grid grid-cols-1 gap-6 lg:grid-cols-2'>
        {/* Pricing Information */}
        <div className='bg-card border-sitora-primary rounded-3xl border p-6'>
                ...
                <div className='space-y-2'>
                  {pricing.pricePerAdult && (
                    <div className='flex items-center justify-between'>
                      <div className='flex items-center gap-2'>
                        ...
                        <span className='text-sitora-body text-sm'>{t('adult')}</span>
                      </div>
                      <span className='text-sitora-primary font-bold'>${formatPrice(pricing.pricePerAdult)}</span>
                    </div>
                  )}
                  ...
                  {pricing.pricePerChild && (
                    <div className='flex items-center justify-between'>
                      <div className='flex items-center gap-2'>
                        <Users className='text-sitora-gold-medium h-4 w-4' />
                        <span className='text-sitora-body text-sm'>{t('child')}</span>
                      </div>
                      <span className='text-sitora-primary font-bold'>${formatPrice(pricing.pricePerChild)}</span>
                    </div>
                  )}
                </div>
              </div>
        ...
        <div className='bg-card border-sitora-primary rounded-3xl border p-6'>
          ...
          <div className='space-y-4'>
            <div className='bg-sitora-primary-light rounded-2xl p-4'>
              <h4 className='text-sitora-primary mb-2 font-semibold'>{t('price_per_adult')}</h4>
              <div className='flex items-center justify-between'>
            ...
            <div className='space-y-3'>
              <Button variant='default' size='lg' className='w-full rounded-2xl shadow-none'>
                {t('book_now')}
              </Button>

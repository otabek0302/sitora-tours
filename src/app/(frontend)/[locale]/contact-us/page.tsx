  ...
  return (
    <section className='min-h-screen py-12 md:py-16'>
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        {/* Page Header */}
        <div className='mb-8 flex items-center justify-between border-b'>
        ...
        {/* Main Content Card */}
        <Card className='bg-card border-border rounded-4xl border p-12'>
          <div className='grid grid-cols-1 gap-8 lg:grid-cols-2'>
            ...
            <div className='border-border order-1 rounded-4xl border p-12 lg:order-2'>
              <ContactDetails />
            </div>
          </div>
        </Card>
